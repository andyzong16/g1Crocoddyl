...
urdf_filename = "/home/nzong8/crocoddyl/unitree_ros/robots/g1_description/g1_29dof_rev_1_0.urdf"
g1_mesh = "/home/nzong8/crocoddyl/unitree_ros/robots/g1_description/"
# # Now load the model (using pinocchio)
digit_legs = pinocchio.robot_wrapper.RobotWrapper.BuildFromURDF(filename=str(urdf_filename), package_dirs = [g1_mesh], root_joint=pinocchio.JointModelFreeFlyer())
